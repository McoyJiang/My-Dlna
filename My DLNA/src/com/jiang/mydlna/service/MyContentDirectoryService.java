...
import com.jiang.mydlna.modle.ContentNode;
import com.jiang.mydlna.modle.ContentTree;

public class MyContentDirectoryService extends AbstractContentDirectoryService {
	private final String TAG = "MyContentDirectoryService";
	...
	public BrowseResult browse(String objectID, BrowseFlag browseFlag, String filter,
		...
		Log.e(TAG, "ContentDirectoryService---browse()--objectID is " + objectID);
		try {
